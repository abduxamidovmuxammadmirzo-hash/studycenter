    ...
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-800/70 bg-slate-900/80 p-6 shadow-xl shadow-slate-950/20 backdrop-blur-md">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm text-slate-400">Добавление ученика</p>
            <h1 className="mt-2 text-3xl font-semibold text-white">Новый ученик</h1>
          </div>
      ...
      <div className="rounded-3xl border border-slate-800/70 bg-slate-950/80 p-6 shadow-xl shadow-slate-950/20">
        <p className="text-slate-400">Здесь можно реализовать форму добавления нового ученика с полями для имени, контактов, группы и платежей.</p>
      </div>
    </div>
  );
}
